...
def train_net(args, ctx, pretrained, pretrained_flow, epoch, prefix, begin_epoch, end_epoch, lr, lr_step):
    ...
    config.dataset.dataset = 'kinetics'
    config.dataset.root_path = '/data/weik/Kinetics400/'
    config.dataset.dataset_path = '/data/waybarrios/kinetics400/JPG_train/'
    config.dataset.traintestlist_path = '/data/weik/Kinetics400/annotationlist/'
    ...
    gtdb, gtviddb = load_gt_imdb(config.dataset.dataset, config.dataset.root_path, config.dataset.dataset_path,
                        config.dataset.traintestlist_path, flip=config.TRAIN.FLIP)
