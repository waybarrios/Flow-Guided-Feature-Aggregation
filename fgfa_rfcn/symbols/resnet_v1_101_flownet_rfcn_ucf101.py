...
class resnet_v1_101_flownet_rfcn_ucf101(Symbol):
    ...
    def get_train_heat_flow(self,cfg):
        ...
        #classification
        fc2 = mx.sym.FullyConnected(name='fc2', data=dropout1, num_hidden=num_classes)
    ...
    def init_weight(self, cfg, arg_params, aux_params):
        ...
        #arg_params['fc3_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fc3_weight'])
        #arg_params['fc3_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fc3_bias'])
